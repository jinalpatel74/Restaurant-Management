   ...
   <tr align="center">   
   	    ...
   	    <td> 
   	    	<select class="text" name="cat" onchange="showUser(this.value)">
   	    		...
   	    		<option value="rise">Rice</option>
   	    		<option value="tava">Rotla/Paratha</option>
   	    	</select>
   	    </td>
	...
	<tr align="center"> 
			...
			<td><textarea rows="4" name="detail" cols="40" class="ar" style="background-color: rgb(255, 255, 255); color:black; padding: 10px;"></textarea></td>
	</tr>
